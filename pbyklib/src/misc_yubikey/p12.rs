...
fn categorize_sig_cert() {
    use hex_literal::hex;
    let der_cert = hex!(
        ""
    );
    let cert = Certificate::from_der(&der_cert).unwrap(); // allow unwrap in test
    let slot_id = get_slot_from_sig_or_auth_cert(&cert).unwrap(); // allow unwrap in test
...
fn categorize_auth_cert() {
    use hex_literal::hex;
    let der_cert = hex!(
        ""
    );
    let cert = Certificate::from_der(&der_cert).unwrap(); // allow unwrap in test
    let slot_id = get_slot_from_sig_or_auth_cert(&cert).unwrap(); // allow unwrap in test
...
fn categorize_enc_cert() {
    use hex_literal::hex;
    let der_cert = hex!(
        ""
    );
    let cert = Certificate::from_der(&der_cert).unwrap(); // allow unwrap in test
    assert!(get_slot_from_sig_or_auth_cert(&cert).is_err());
    assert!(check_key_encipherment(&cert).unwrap()); // allow unwrap in test
}
...
//         Err(e) => {
//             println!(
//                 "p12_test_rc2 failed with: {e}. Make sure Cargo.lock has not rolled openssl, openssl-src and openssl-sys beyond 0.10.55, 111.26.0+1.1.1u and 0.9.90, respectively."
//             );
//             panic!();
//         }
//     };
